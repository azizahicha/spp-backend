...
let SiswaController = class SiswaController {
    ...
    findOne(id) { return this.siswaService.findOne(+id); }
    create(body) { return this.siswaService.create(body); }
    update(id, body) { return this.siswaService.update(+id, body); }
    remove(id) { return this.siswaService.remove(+id); }
};
